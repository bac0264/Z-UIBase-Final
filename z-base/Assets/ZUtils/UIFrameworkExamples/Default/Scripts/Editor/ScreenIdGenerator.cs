...
namespace deVoid.UIFramework.Editor
{
    ...
    {
        private const string UIPrefabFolder = "Assets/UIFrameworkExamples/Default/Resources/Prefabs/Screens";
        private const string UIIdScriptFolder = "Assets/UIFrameworkExamples/Default/Scripts";
