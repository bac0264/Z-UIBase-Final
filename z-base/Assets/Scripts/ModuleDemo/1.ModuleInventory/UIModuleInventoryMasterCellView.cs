...
public class UIModuleInventoryMasterCellView : EnhancedScrollerCellView, IEnhancedScrollerDelegate
{
    ...
    /// </summary>
    private InventoryItemContainer _data;
    ...
    private Action<ItemResource> OnRightClickEvent;
    ...
    public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
    {
        ...
        UIModuleInventoryItemView detailCellView = scroller.GetCellView(detailCellViewPrefab) as UIModuleInventoryItemView;

        // set the name of the game object to the cell's data index.
        // this is optional, but it helps up debug the objects in 
        // the scene hierarchy.
        detailCellView.name = "UIModuleInventoryItemView" + dataIndex.ToString();

        // in this example, we just pass the data to our cell's view which will update its UI
        detailCellView.SetData(_data.childData[dataIndex], OnRightClickEvent);
